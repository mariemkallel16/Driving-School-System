                        ...
                        <div class="card-body">
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    ...
                                    <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">Nouveaux candidats</h6>
                                </div>
                            ...
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    <h2 class="text-dark mb-1 w-100 text-truncate font-weight-medium"><sup
                                            class="set-doller">DT</sup>20000</h2>
                        ...
                        <div class="card-body">
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    ...
                                    <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">Examens</h6>
                                </div>
                                <div class="ml-auto mt-md-3 mt-lg-0">
