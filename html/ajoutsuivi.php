...
<body>
    ...
    {   
        ...
        $sql = "INSERT INTO suivicandidat(id, avancement,heuresAssurees,heuresRestantes,remarques) VALUES (?,?,?,?,?)";
        $stmtinsert = $db->prepare($sql);
        $result = $stmtinsert -> execute([$id,$avancement,$heuresAssurees,$heuresRestantes,$remarques]);
        if ($result)
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center position-relative"
            ...
            <div class="auth-box row text-center">
                    ...
                    <div class="p-3">
                        ...
                        <h2 class="mt-3 text-center">Ajouter un suivi</h2>
                        <form class="mt-4" action="ajoutsuivi.php" method="POST" >
                            <div class="row">
                                  <div class="col-lg-12">
...
?>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <input class="form-control" name="avancement" type="text" placeholder="Avancement" required >
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <input class="form-control" name="heuresAssurees" type="text" placeholder="HeuresAssurées" required >
                                    </div>
                                </div>
                                    <div class="col-lg-12">
                                    <div class="form-group">
                                        <input class="form-control" name="heuresRestantes" type="text" placeholder="Heures Restantes"  required>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                <div class="form-group">
                                        <input class="form-control" name="remarques" type="text" placeholder="Remarques" required >
                                    </div>
                                </div>
