            ...
            <div class="scroll-sidebar" data-sidebarbg="skin6">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="calendrier.php"
                                aria-expanded="false"><i data-feather="calendar" class="feather-icon"></i><span
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php
                            ...
                            $reponse = $db->query('SELECT * FROM seancesformation');
                        ...
                        ?>
                                            <tr>
                                                    <td><?php echo $entree['dateFormation']; ?></td>
                                                    <td><a href="javascript:void(0)" class="font-weight-medium link"><?php echo $entree['horaire']; ?></a></td>
