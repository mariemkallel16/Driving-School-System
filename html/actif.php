            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h3 class="page-title text-truncate text-dark font-weight-medium mb-1">Demandes </h3>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="accueilsuperadmin.php">Liste d'attente</a>
                                    </li>
                                </ol>
                            </nav>
                        </div>
...
$reponse = $db->query('SELECT id, firstname, lastname, email, homeadress, phonenumber, username FROM users WHERE role = 0 AND actif = 0 ');
...
?>
                                            <tr>
                                                    ...
                                                    <td>
                                                        <?php echo  " <button type=\"button\" class=\"btn btn-danger btn-circle\"><i class=\"fa fa-times\"></i>
                                </button> " ?>
                                                    </td>
                                                    <td><a href="editdem.php?id=<?php echo $entree['id']?>">Accepter</a> | <a href="deletedem.php?id=<?php echo $entree['id']?>">Supprimer</a></td>
                                            </tr>
                           <?php 
               } 
          ?>                   
