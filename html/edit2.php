    ...
    <div>
        <?php
                if(ISSET($_GET['id'])){
                    ...
                    $id = $_GET['id'];
                    $sql = $db->prepare("SELECT * FROM `paiement` WHERE `id`='$id'");
                    $sql->execute();
                    $entree = $sql->fetch();
                }
            ?>
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center position-relative"
            ...
            <div class="auth-box row text-center">
                    ...
                    <div class="p-3">
                        ...
                        <form class="mt-4" method="POST" action="update2.php?id=<?php echo $id?>">
                        
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <input class="form-control" name="Paye" type="text" value="<?php echo $entree['Paye']?>" required >
                                    </div>
                                </div>

                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <input class="form-control" name="ResteApayer" type="text" value="<?php echo $entree['ResteApayer']?>" required >
                                    </div>
                                </div>
