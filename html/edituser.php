    ...
    <div>
        <?php
                if(ISSET($_GET['id'])){
                    ...
                    $id = $_GET['id'];
                    $sql = $db->prepare(" SELECT examens.dateExamen, examens.typeExamen, examens.ResultatExamen,users.firstname, users.lastname  FROM examens, users WHERE examens.id = users.id ");
                    $sql->execute();
                    $entree = $sql->fetch();
                }
            ?>
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center position-relative"
            ...
            <div class="auth-box row text-center">
                    ...
                    <div class="p-3">
                        ...
                        <form class="mt-4" method="POST" action="updateuser.php?id=<?php echo $id?>">
                        
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <input class="form-control" name="dateExamen" type="date" value="<?php echo $entree['avancement']?>" required >
                                    </div>
                                </div>
