    ...
    <div>
        <?php
                if(ISSET($_GET['ide'])){
                    ...
                    $ide = $_GET['ide'];
                    $sql = $db->prepare("SELECT * FROM `entretiens` WHERE `ide`='$ide'");
                    $sql->execute();
                    $entree = $sql->fetch();
                }
            ?>
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center position-relative"
            ...
            <div class="auth-box row text-center">
                    ...
                    <div class="p-3">
                        ...
                        <form class="mt-4" method="POST" action="updateentr.php?ide=<?php echo $ide?>">
                        
                            <div class="row">
                            	 <div class="col-lg-12">
                                    <div class="form-group">
                                        <input class="form-control" name="ide" type="text" value="<?php echo $entree['ide']?>" required >
                                    </div>
                                </div>
...
?>
                                ...
                                <div class="col-lg-14">
                                    <div class="form-group">
                                        <input class="form-control" name="dateEntretien" type="date" value="<?php echo $entree['dateEntretien']?>" required>
                                    </div>
                                </div>
