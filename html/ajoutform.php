...
<body>
     ...
     if (isset($_POST['create']))
    {
        ...
        $id       = $_POST['lastname'];
        $type       = $_POST['type'];
        $sql = "INSERT INTO seancesformation(dateFormation,horaire,type,idEmploye,id) VALUES (?,?,?,?,?)";
        $stmtinsert = $db->prepare($sql);
        $result = $stmtinsert -> execute([$dateFormation,$horaire,$type,$idEmploye,$id]);
        if ($result)
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center position-relative"
            ...
            <div class="auth-box row text-center">
                    ...
                    <div class="p-3">
                        ...
                        <h2 class="mt-3 text-center">Ajouter une séance</h2>
                        <form class="mt-4" action="ajoutform.php" method="POST" >
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <input class="form-control" name="dateFormation" type="date" placeholder="date Formation" required >
                                    </div>
                                </div>

                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <input class="form-control" name="horaire"  type="time" placeholder="Horaire" required >
                                    </div>
                                </div>
                                    <div class="col-lg-12">
                                    <div class="form-group">
                                        <input class="form-control" name="type"  type="type" placeholder="Type de séance" required >
...
?>
                                            ...
                                            <option value="<?php echo $entree['idEmploye']; ?> " ><?php echo $entree['Prenom'] ."  ". $entree['Nom']   ; ?></option>
                                            <?php 
} ?>
