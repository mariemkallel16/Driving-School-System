...
<body>
     ...
     if (isset($_POST['create']))
    {
        ...
        $sql = "INSERT INTO examens(dateExamen,typeExamen,ResultatExamen,id) VALUES (?,?,?,?)";
        $stmtinsert = $db->prepare($sql);
        $result = $stmtinsert -> execute([$dateExamen,$typeExamen,$ResultatExamen,$id]);
        if ($result)
            {echo 'Successfully saved';
        header("Location: accueilsuperadmin.php");} else {
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center position-relative"
            ...
            <div class="auth-box row text-center">
                    ...
                    <div class="p-3">
                        ...
                        <h2 class="mt-3 text-center">Ajouter un examen</h2>
                        <form class="mt-4" action="ajoutexam.php" method="POST" >
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <input class="form-control" name="dateExamen" type="date" placeholder="date d examen" required >
                                    </div>
                                </div>
 ...
 <form>
                                    <div class="form-group mb-4">
                                        ...
                                        <input class="form-control" name="typeExamen" type="text" placeholder="type d'examen" required >
...
?>
                                    ...
                                    <br>
                                         <div class="form-group mb-4">
                                    <select class="form-control" name="ResultatExamen" >
                                        <option>Etat</option>
                                    <option value="refait">Refait</option> 
                                    <option value="réussi">Réussi</option>
                                    <option value="pas encore passé" >Pas encore passé</option>
                                </select>
                                </div>
                                    </div>
                                </div>
