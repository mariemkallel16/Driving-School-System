            ...
            <div class="scroll-sidebar" data-sidebarbg="skin6">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link" href="quiz.php"
                                aria-expanded="false"><i data-feather="tag" class="feather-icon"></i><span
                                    class="hide-menu">Quiz
                                </span></a>
                        </li>
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="profiluser.php">Mon profil</a>
                                    </li>
                                </ol>
                            </nav>
                        </div>
            ...
            <div class="container-fluid">
                                ...
                                <form action="updateprof.php" method="POST">
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <label class="col-lg-1">Prénom:</label>
                                                <div class="col-lg-11">
                                                    <div class="row">
                                                        <div class="col-md-2">
                                                            <input type="text" class="form-control"
                                                                placeholder="prénom" value="<?php 
                                                                echo $_SESSION["x"];
                                                            ?>">
                                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <label class="col-lg-1">Mot de passe:</label>
                                                <div class="col-lg-11">
                                                    <div class="row">
                                                        <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <label class="col-lg-1">Adresse actuelle: </label>
                                                <div class="col-lg-11">
                                                    <div class="row">
                                                        <div class="col-md-5">
                                                            <input type="text" class="form-control"
                                                                placeholder="adresse" value="<?php 
                                                                echo $_SESSION["x5"];
                                                            ?>">
                                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <label class="col-lg-1">Téléphone:</label>
                                                <div class="col-lg-11">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <input type="text" class="form-control"
                                                                placeholder="téléphone" value="<?php 
                                                                echo $_SESSION["x6"];
                                                            ?>">
                                                        </div>
