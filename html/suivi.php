...
$reponse = $db->query('SELECT users.id, suivicandidat.avancement, suivicandidat.heuresAssurees, suivicandidat.heuresRestantes,suivicandidat.remarques ,users.firstname, users.lastname FROM suivicandidat, users WHERE suivicandidat.id = users.id');
...
?>
                                            <tr>
                                                    ...
                                                    <td><a href="editsuivi.php?id=<?php echo $entree['id']?>">Edit</a> | <a href="deletesuivi.php?id=<?php echo $entree['id']?>">Delete</a></td>
                                            </tr>
                           <?php
          ...
          ?>                   
                                        ...
                                        <a href="ajoutsuivi.php">  <button type="button" class="btn btn-dark" href="ajoutexamen.php">Ajouter un suivi </button> </a>
                                        <br/>
                                        <br/>
