            ...
            <div class="scroll-sidebar" data-sidebarbg="skin6">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="entretiens.php"
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    ...
                                    <li class="breadcrumb-item text-muted" aria-current="page">Entretiens</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        ?>
                                            <tr>
                                                    ...
                                                    <td><a href="javascript:void(0)" class="font-weight-medium link"><?php echo $entree['typeEntretien']; ?></a></td>
                                                    <td><a href="javascript:void(0)" class="font-bold link"><?php echo $entree['matricule']; ?></a></td>
                                                    
                                                    <td><a href="edit.php?id=<?php echo $entree['id']?>">Edit</a> | <a href="deletemployes.php?id=<?php echo $entree['id']?>">Delete</a></td>
