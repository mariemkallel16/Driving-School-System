                ...
                <div class="page-breadcrumb">
                    <div class="row">
                        <div class="col-7 align-self-center">
                            <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Calendrier des entretiens </h4>
                            <div class="d-flex align-items-center">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb m-0 p-0">
                                        <li class="breadcrumb-item"><a href="index.html" class="text-muted">Fonctionnalités</a></li>
                                        <li class="breadcrumb-item text-muted active" aria-current="page">Entretiens</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
...
$nb = $db->query('SELECT COUNT(dateEntretien) FROM entretiens');
echo $nb->fetchColumn();

?></h1>
                                                    <h6 class="text-white">Entretiens</h6>
                                                </div>
                                            </div>
                                        </div>
...
$reponse = $db->query('SELECT * FROM entretiens');
...
?>
                                            <tr>
                                                   <td><?php echo $entree['ide']; ?></td>
                                                    <td><?php echo $entree['dateEntretien']; ?></td>
                                                    
                                                    <td><a href="javascript:void(0)" class="font-bold link"><?php echo $entree['matricule']; ?></a></td>
                                                    
                                                    <td><a href="editentr.php?ide=<?php echo $entree['ide']?>">Edit</a> | <a href="deleteentr.php?ide=<?php echo $entree['ide']?>">Delete</a></td>
                                                    <td> <?php
                                                            $v= "vidange";
                                                            $v1= "contrôle des freins";
                                                            $v2="remplacement du filtre";
                                                            if (strcmp($entree ['typeEntretien'],$v) ==0)
                                                              {echo "<div class=\"alert alert-success\" role=\"alert\">
                                    <i class=\"dripicons-checkmark mr-2\"></i>  <strong>Vidange</strong> 
                                </div>";}
                                                            if (strcmp($entree ['typeEntretien'],$v1) ==0)
                                                              {echo "<div class=\"alert alert-danger\" role=\"alert\">
                                    <i class=\"dripicons-wrong mr-2\"></i>  <strong>Controle Freins</strong> 
                                </div>";}     
                                                            if (strcmp($entree ['typeEntretien'],$v2) ==0)
                                                              {echo "<div class=\"alert alert-warning\" role=\"alert\">
                                    <i class=\"dripicons-warning mr-2\"></i>  <strong>Remplacement filtre</strong> 
                                </div>";}     
          ...
          ?>                   
                                        ...
                                        <a href="ajoutentr.php">  <button type="button" class="btn btn-dark" href="ajoutexamen.php">Ajouter un entretien </button> </a>
                                        <br/>
                                        <br/>
