...
<body>
     ...
     if (isset($_POST['create']))
    {
        ...
        $sql = "INSERT INTO entretiens(dateEntretien, matricule, typeEntretien) VALUES (?,?,?)";
        $stmtinsert = $db->prepare($sql);
        $result = $stmtinsert -> execute([$dateEntretien,$matricule,$typeEntretien]);
        if ($result)
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center position-relative"
            ...
            <div class="auth-box row text-center">
                    ...
                    <div class="p-3">
                        ...
                        <h2 class="mt-3 text-center">AJOUTER UN ENTRETIEN</h2>
                        <form class="mt-4" action="ajoutentr.php" method="POST" >
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <input class="form-control" name="dateEntretien" type="date" placeholder="dateEntretien" required>
                                    </div>
                                </div>
...
?>
                                            ...
                                            <option value="<?php echo $entree['matricule']; ?> " ><?php echo $entree['matricule'] ."  ". $entree['marque']   ; ?></option>
                                            <?php 
} ?>
                                    ...
                                    <div class="col-lg-14">
                                    <div class="form-group">
                                       <select class="form-control" name="typeEntretien" >
                                        <option value="vidange">vidange</option> 
                                        <option value="contrôle des freins">contrôle des freins</option>
                                        <option value="remplacement du filtre" >remplacement du filtre</option>
                                        </select>
                                    </div>
                                </div>
                                <br>
