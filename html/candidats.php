                ...
                <div class="page-breadcrumb">
                    <div class="row">
                        <div class="col-7 align-self-center">
                            <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Candidats </h4>
                            <div class="d-flex align-items-center">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb m-0 p-0">
                                        <li class="breadcrumb-item"><a href="index.html" class="text-muted">Fonctionnalités</a></li>
                                        <li class="breadcrumb-item text-muted active" aria-current="page">Candidats</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
...
$nb = $db->query('SELECT COUNT(id) FROM users where role=0');
echo $nb->fetchColumn();
...
$reponse = $db->query('SELECT id, firstname, lastname, email, homeadress, phonenumber, username FROM users where actif=1');
...
?>
                                            <tr>
                                                    ...
                                                    <td><a href="javascript:void(0)" class="font-weight-medium link"><?php echo $entree['firstname']; ?></a></td>
                                                    <td><a href="javascript:void(0)" class="font-bold link"><?php echo $entree['lastname']; ?></a></td>
                                                    <td><?php echo $entree['email']; ?></td>
                                                    <td><?php echo $entree['homeadress']; ?></td>
                                                    <td><?php echo $entree['phonenumber']; ?></td>
                                                    <td><?php echo $entree['username']; ?></td>
                                                    <td><a href="edit.php?id=<?php echo $entree['id']?>">Edit</a> | <a href="delete.php?id=<?php echo $entree['id']?>">Delete</a></td>
                                            </tr>
                           <?php 
               } 
          ?>                   
                                        </table>
                                        <a href="ajout.php">  <button type="button" class="btn btn-dark" href="ajoutexamen.php">Ajouter un candidat </button> </a>
