            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Paiement</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="index.html" class="text-muted">Extra</a></li>
                                    <li class="breadcrumb-item text-muted active" aria-current="page">Paiement</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
...
?></h1>
                                                    <h6 class="text-white">Revenus</h6>
                                                </div>
                                            </div>
                                        </div>
...
$reponse = $db->query('SELECT paiement.id, paiement.Paye, paiement.ResteApayer, users.firstname, users.lastname FROM paiement, users WHERE paiement.id=users.id');
// En utilisant une boucle, on affiche chaque entrée (ligne) lue dans le résultat retourné
$paiement=$reponse->fetchAll() ;
foreach($paiement as $entree ) 
{
 
?>
                                            <tr>
                                                    <td><?php echo $entree['firstname']; ?></td>
                                                    <td><?php echo $entree['lastname']; ?></td>
                                                    <td><a href="javascript:void(0)" class="font-weight-medium link"><?php echo $entree['Paye']; ?></a></td>
                                                    <td><a href="javascript:void(0)" class="font-bold link"><?php echo $entree['ResteApayer']; ?></a></td>
                                                    <td><a href="edit2.php?id=<?php echo $entree['id']?>">Edit</a> | <a href="delete2.php?id=<?php echo $entree['id']?>">Delete</a></td>
          ...
          ?>                   
                                    ...
                                    <a href="ajout2.php">  <button type="button" class="btn btn-dark" >Ajouter un paiement </button> </a>
